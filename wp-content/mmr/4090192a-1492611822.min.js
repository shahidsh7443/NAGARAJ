...
return deferred}}})(jQuery,window);window.wp=window.wp||{};(function(wp,$){'use strict';var $containerPolite,$containerAssertive,previousMessage='';function speak(message,ariaLive){clear();message=$('<p>').html(message).text();if(previousMessage===message){message=message+'\u00A0'}
